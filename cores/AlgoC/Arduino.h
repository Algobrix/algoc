...
enum ALGOBOT_STATE
{
    ALGOBOT_STATE_IDLE = 0x00,
    ALGOBOT_STATE_RUN,
    ALGOBOT_STATE_WAIT4STOP,
    ALGOBOT_STATE_HALT,
    ALGOBOT_STATE_PAUSE,
    ALGOBOT_STATE_INIT,
    ALGOBOT_STATE_POWER_OFF,
    ALGOBOT_STATE_POWER_ON,
};
...
enum OP_STATUS
{
    OP_STATUS_NONBLOCKING = 0x00,
    OP_STATUS_BLOCKING = 0x01,
    NONBLOCKING = 0x00,
    BLOCKING = 0x01,
	OP_STATUS_COMPLETED = 0x00,
	OP_STATUS_RUNNING = 0x01,
};
...
enum
{
	SERIAL_CONTROL_PLAY = 0x01,

};

extern volatile ALGOBOT_INFO g_ALGOBOT_INFO;
extern uint8_t g_playState;
extern uint32_t g_playTimer;
extern uint8_t g_serial_control_flags;
